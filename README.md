# Prezentace
 ...
 [CSS](presentation/CSS/CSS.MD)

 [Architektura](presentation/Architecture/architecture.md)

 [Administrace](presentation/Administration/Administration.MD)

- ostatní - ATM, vývoj ATM, Rest API příklad
...
[Administrace](labs/Administration/Administation.MD)