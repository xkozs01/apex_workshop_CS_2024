...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(14121038949458150)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1941358906116529851)
,p_plugin_id=>wwv_flow_imp.id(14121038949458150)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1941358351104529850)
,p_plugin_id=>wwv_flow_imp.id(14121038949458150)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1684466287374256337)
,p_plugin_id=>wwv_flow_imp.id(14121038949458150)
,p_title=>'Appearance'
,p_display_sequence=>30
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14121961690458158)
,p_plugin_id=>wwv_flow_imp.id(14121038949458150)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14122260325458159)
,p_plugin_id=>wwv_flow_imp.id(14121038949458150)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14122513609458160)
,p_plugin_id=>wwv_flow_imp.id(14121038949458150)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14122803924458161)
,p_plugin_id=>wwv_flow_imp.id(14121038949458150)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14123143705458162)
,p_plugin_id=>wwv_flow_imp.id(14121038949458150)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14123404576458163)
,p_plugin_id=>wwv_flow_imp.id(14121038949458150)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14123729359458163)
,p_plugin_id=>wwv_flow_imp.id(14121038949458150)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(14123143705458162)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(1941358906116529851)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14124051841458164)
,p_plugin_attribute_id=>wwv_flow_imp.id(14123729359458163)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14124419653458165)
,p_plugin_attribute_id=>wwv_flow_imp.id(14123729359458163)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14124879041458166)
,p_plugin_attribute_id=>wwv_flow_imp.id(14123729359458163)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14125232472458168)
,p_plugin_id=>wwv_flow_imp.id(14121038949458150)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(14123729359458163)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14125523441458169)
,p_plugin_id=>wwv_flow_imp.id(14121038949458150)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14125829591458169)
,p_plugin_id=>wwv_flow_imp.id(14121038949458150)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14126156594458170)
,p_plugin_id=>wwv_flow_imp.id(14121038949458150)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14126467128458171)
,p_plugin_id=>wwv_flow_imp.id(14121038949458150)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14126704354458171)
,p_plugin_attribute_id=>wwv_flow_imp.id(14126467128458171)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14127153755458172)
,p_plugin_attribute_id=>wwv_flow_imp.id(14126467128458171)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14127519563458173)
,p_plugin_attribute_id=>wwv_flow_imp.id(14126467128458171)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14127909552458174)
,p_plugin_attribute_id=>wwv_flow_imp.id(14126467128458171)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14128378615458175)
,p_plugin_id=>wwv_flow_imp.id(14121038949458150)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'RAW'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(14123404576458163)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(1941358351104529850)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14128601463458176)
,p_plugin_id=>wwv_flow_imp.id(14121038949458150)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14128922677458176)
,p_plugin_id=>wwv_flow_imp.id(14121038949458150)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14129278141458177)
,p_plugin_id=>wwv_flow_imp.id(14121038949458150)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14129589486458178)
,p_plugin_id=>wwv_flow_imp.id(14121038949458150)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14129803920458178)
,p_plugin_id=>wwv_flow_imp.id(14121038949458150)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14130170574458179)
,p_plugin_attribute_id=>wwv_flow_imp.id(14129803920458178)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14130557642458180)
,p_plugin_attribute_id=>wwv_flow_imp.id(14129803920458178)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14130904171458181)
,p_plugin_id=>wwv_flow_imp.id(14121038949458150)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14131273688458181)
,p_plugin_attribute_id=>wwv_flow_imp.id(14130904171458181)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14131634674458182)
,p_plugin_attribute_id=>wwv_flow_imp.id(14130904171458181)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14132098978458183)
,p_plugin_attribute_id=>wwv_flow_imp.id(14130904171458181)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14132428248458183)
,p_plugin_attribute_id=>wwv_flow_imp.id(14130904171458181)
,p_display_sequence=>40
,p_display_value=>'No Shape'
,p_return_value=>'t-Avatar--noShape'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14132816151458184)
,p_plugin_id=>wwv_flow_imp.id(14121038949458150)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14133130680458185)
,p_plugin_attribute_id=>wwv_flow_imp.id(14132816151458184)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14133501418458187)
,p_plugin_attribute_id=>wwv_flow_imp.id(14132816151458184)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14133939890458188)
,p_plugin_attribute_id=>wwv_flow_imp.id(14132816151458184)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14134330736458190)
,p_plugin_attribute_id=>wwv_flow_imp.id(14132816151458184)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14134722529458191)
,p_plugin_attribute_id=>wwv_flow_imp.id(14132816151458184)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14135127868458191)
,p_plugin_attribute_id=>wwv_flow_imp.id(14132816151458184)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14135548996458192)
,p_plugin_attribute_id=>wwv_flow_imp.id(14132816151458184)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14135996757458193)
,p_plugin_id=>wwv_flow_imp.id(14121038949458150)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14136242989458194)
,p_plugin_attribute_id=>wwv_flow_imp.id(14135996757458193)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-Badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14136652258458195)
,p_plugin_attribute_id=>wwv_flow_imp.id(14135996757458193)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14137066494458196)
,p_plugin_attribute_id=>wwv_flow_imp.id(14135996757458193)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14137464511458197)
,p_plugin_id=>wwv_flow_imp.id(14121038949458150)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14137748101458198)
,p_plugin_attribute_id=>wwv_flow_imp.id(14137464511458197)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-ContentRow-badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14138122424458199)
,p_plugin_attribute_id=>wwv_flow_imp.id(14137464511458197)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14138585443458200)
,p_plugin_attribute_id=>wwv_flow_imp.id(14137464511458197)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14138981961458202)
,p_plugin_attribute_id=>wwv_flow_imp.id(14137464511458197)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14139310305458203)
,p_plugin_id=>wwv_flow_imp.id(14121038949458150)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14139690654458204)
,p_plugin_attribute_id=>wwv_flow_imp.id(14139310305458203)
,p_display_sequence=>10
,p_display_value=>'End'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14140012312458205)
,p_plugin_id=>wwv_flow_imp.id(14121038949458150)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14140307807458205)
,p_plugin_attribute_id=>wwv_flow_imp.id(14140012312458205)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14140716897458206)
,p_plugin_attribute_id=>wwv_flow_imp.id(14140012312458205)
,p_display_sequence=>20
,p_display_value=>'End'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14141169797458207)
,p_plugin_id=>wwv_flow_imp.id(14121038949458150)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14141414844458208)
,p_plugin_id=>wwv_flow_imp.id(14121038949458150)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14141765877458210)
,p_plugin_id=>wwv_flow_imp.id(14121038949458150)
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_attribute_group_id=>wwv_flow_imp.id(1684466287374256337)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14142009544458211)
,p_plugin_id=>wwv_flow_imp.id(14121038949458150)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14142360675458212)
,p_plugin_attribute_id=>wwv_flow_imp.id(14142009544458211)
,p_display_sequence=>10
,p_display_value=>'Compact'
,p_return_value=>'t-ContentRow--styleCompact'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14142747908458213)
,p_plugin_id=>wwv_flow_imp.id(14121038949458150)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14143033425458214)
,p_plugin_id=>wwv_flow_imp.id(14121038949458150)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(1822572796332351465)
,p_plugin_id=>wwv_flow_imp.id(14121038949458150)
,p_name=>'Button'
,p_type=>'BUTTON'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(1822574055852355613)
,p_plugin_id=>wwv_flow_imp.id(14121038949458150)
,p_name=>'Menu'
,p_type=>'MENU'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1525621281436593035)
,p_plugin_id=>wwv_flow_imp.id(14121038949458150)
,p_name=>'Badge Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1808979167657944732)
,p_plugin_id=>wwv_flow_imp.id(14121038949458150)
,p_name=>'Title Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1809658468388027836)
,p_plugin_id=>wwv_flow_imp.id(14121038949458150)
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1822570861265306479)
,p_plugin_id=>wwv_flow_imp.id(14121038949458150)
,p_name=>'Avatar Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1822572194655320336)
,p_plugin_id=>wwv_flow_imp.id(14121038949458150)
