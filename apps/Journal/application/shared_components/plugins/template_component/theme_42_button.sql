...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(14076502667457990)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14076835327457991)
,p_plugin_id=>wwv_flow_imp.id(14076502667457990)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14077157705457992)
,p_plugin_id=>wwv_flow_imp.id(14076502667457990)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14077462797457993)
,p_plugin_id=>wwv_flow_imp.id(14076502667457990)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14077756538457993)
,p_plugin_id=>wwv_flow_imp.id(14076502667457990)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14078030277457994)
,p_plugin_id=>wwv_flow_imp.id(14076502667457990)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14078315568457995)
,p_plugin_id=>wwv_flow_imp.id(14076502667457990)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14078666472457995)
,p_plugin_id=>wwv_flow_imp.id(14076502667457990)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14078954164457999)
,p_plugin_id=>wwv_flow_imp.id(14076502667457990)
,p_attribute_scope=>'COMPONENT'
