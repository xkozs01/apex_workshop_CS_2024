...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(28267759700134196)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(28268092360134197)
,p_plugin_id=>wwv_flow_imp.id(28267759700134196)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(28268414738134198)
,p_plugin_id=>wwv_flow_imp.id(28267759700134196)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(28268719830134199)
,p_plugin_id=>wwv_flow_imp.id(28267759700134196)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(28269013571134199)
,p_plugin_id=>wwv_flow_imp.id(28267759700134196)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(28269287310134200)
,p_plugin_id=>wwv_flow_imp.id(28267759700134196)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(28269572601134201)
,p_plugin_id=>wwv_flow_imp.id(28267759700134196)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(28269923505134201)
,p_plugin_id=>wwv_flow_imp.id(28267759700134196)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(28270211197134205)
,p_plugin_id=>wwv_flow_imp.id(28267759700134196)
,p_attribute_scope=>'COMPONENT'
