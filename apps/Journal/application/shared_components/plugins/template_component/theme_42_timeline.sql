...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(14095772444458056)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(2161179226886565012)
,p_plugin_id=>wwv_flow_imp.id(14095772444458056)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(2161178671874565011)
,p_plugin_id=>wwv_flow_imp.id(14095772444458056)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14096434514458062)
,p_plugin_id=>wwv_flow_imp.id(14095772444458056)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14096769273458062)
,p_plugin_id=>wwv_flow_imp.id(14095772444458056)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14097046711458063)
,p_plugin_id=>wwv_flow_imp.id(14095772444458056)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14097321895458064)
,p_plugin_id=>wwv_flow_imp.id(14095772444458056)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14097660408458065)
,p_plugin_id=>wwv_flow_imp.id(14095772444458056)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14097942299458065)
,p_plugin_id=>wwv_flow_imp.id(14095772444458056)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14098271929458066)
,p_plugin_id=>wwv_flow_imp.id(14095772444458056)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(14097660408458065)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(2161179226886565012)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14098576499458067)
,p_plugin_attribute_id=>wwv_flow_imp.id(14098271929458066)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14098929279458068)
,p_plugin_attribute_id=>wwv_flow_imp.id(14098271929458066)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14099360147458069)
,p_plugin_attribute_id=>wwv_flow_imp.id(14098271929458066)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14099758568458069)
,p_plugin_id=>wwv_flow_imp.id(14095772444458056)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(14098271929458066)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14100004779458070)
,p_plugin_id=>wwv_flow_imp.id(14095772444458056)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14100349868458071)
,p_plugin_id=>wwv_flow_imp.id(14095772444458056)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14100652175458072)
,p_plugin_id=>wwv_flow_imp.id(14095772444458056)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14100938706458072)
,p_plugin_id=>wwv_flow_imp.id(14095772444458056)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14101252790458073)
,p_plugin_attribute_id=>wwv_flow_imp.id(14100938706458072)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14101676650458074)
,p_plugin_attribute_id=>wwv_flow_imp.id(14100938706458072)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14102015989458074)
,p_plugin_attribute_id=>wwv_flow_imp.id(14100938706458072)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14102457787458075)
,p_plugin_attribute_id=>wwv_flow_imp.id(14100938706458072)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14102884820458076)
,p_plugin_id=>wwv_flow_imp.id(14095772444458056)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'RAW'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(14097942299458065)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(2161178671874565011)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14103186906458077)
,p_plugin_id=>wwv_flow_imp.id(14095772444458056)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14103451008458078)
,p_plugin_id=>wwv_flow_imp.id(14095772444458056)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14103784347458079)
,p_plugin_id=>wwv_flow_imp.id(14095772444458056)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14104090945458080)
,p_plugin_id=>wwv_flow_imp.id(14095772444458056)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14104312723458081)
,p_plugin_id=>wwv_flow_imp.id(14095772444458056)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14104694202458082)
,p_plugin_attribute_id=>wwv_flow_imp.id(14104312723458081)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14105070158458083)
,p_plugin_attribute_id=>wwv_flow_imp.id(14104312723458081)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14105408360458084)
,p_plugin_id=>wwv_flow_imp.id(14095772444458056)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14105725172458085)
,p_plugin_attribute_id=>wwv_flow_imp.id(14105408360458084)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14106104006458085)
,p_plugin_attribute_id=>wwv_flow_imp.id(14105408360458084)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14106584765458086)
,p_plugin_attribute_id=>wwv_flow_imp.id(14105408360458084)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14106976778458088)
,p_plugin_id=>wwv_flow_imp.id(14095772444458056)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(14107231429458089)
,p_plugin_attribute_id=>wwv_flow_imp.id(14106976778458088)
,p_display_sequence=>10
,p_display_value=>'Compact'
,p_return_value=>'t-Timeline--compact'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(14107658492458090)
,p_plugin_id=>wwv_flow_imp.id(14095772444458056)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1808948572072773598)
,p_plugin_id=>wwv_flow_imp.id(14095772444458056)
,p_name=>'Title Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1923359935061037199)
,p_plugin_id=>wwv_flow_imp.id(14095772444458056)
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2042391182035341640)
,p_plugin_id=>wwv_flow_imp.id(14095772444458056)
,p_name=>'Avatar Link'
