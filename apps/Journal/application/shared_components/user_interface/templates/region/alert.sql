...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(28105231143133918)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(28105538708133923)
,p_plug_template_id=>wwv_flow_imp.id(28105231143133918)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(28105814563133924)
,p_plug_template_id=>wwv_flow_imp.id(28105231143133918)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(28106084943133925)
,p_plug_template_id=>wwv_flow_imp.id(28105231143133918)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(28106429526133925)
,p_plug_template_id=>wwv_flow_imp.id(28105231143133918)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(28106754421133925)
,p_plug_template_id=>wwv_flow_imp.id(28105231143133918)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(28107042065133925)
,p_plug_template_id=>wwv_flow_imp.id(28105231143133918)
,p_name=>'Sub Regions'
