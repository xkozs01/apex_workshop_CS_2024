...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(28186828407133991)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(28187115155133991)
,p_plug_template_id=>wwv_flow_imp.id(28186828407133991)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(28187362674133991)
,p_plug_template_id=>wwv_flow_imp.id(28186828407133991)
,p_name=>'Tabs'
