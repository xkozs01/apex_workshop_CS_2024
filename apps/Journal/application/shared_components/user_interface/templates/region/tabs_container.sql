...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(13995571374457785)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(13995858122457785)
,p_plug_template_id=>wwv_flow_imp.id(13995571374457785)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(13996105641457785)
,p_plug_template_id=>wwv_flow_imp.id(13995571374457785)
,p_name=>'Tabs'
