...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(28161794455133973)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(28162150184133973)
,p_plug_template_id=>wwv_flow_imp.id(28161794455133973)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(28162376473133974)
,p_plug_template_id=>wwv_flow_imp.id(28161794455133973)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(28162662114133974)
,p_plug_template_id=>wwv_flow_imp.id(28161794455133973)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(28163034387133974)
,p_plug_template_id=>wwv_flow_imp.id(28161794455133973)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(28163286810133974)
,p_plug_template_id=>wwv_flow_imp.id(28161794455133973)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(28163655388133974)
,p_plug_template_id=>wwv_flow_imp.id(28161794455133973)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(28163937188133974)
,p_plug_template_id=>wwv_flow_imp.id(28161794455133973)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(28164186954133974)
,p_plug_template_id=>wwv_flow_imp.id(28161794455133973)
,p_name=>'Sub Regions'
