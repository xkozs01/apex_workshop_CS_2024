...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(13952621789457753)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(13952932209457754)
,p_plug_template_id=>wwv_flow_imp.id(13952621789457753)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(13953291615457755)
,p_plug_template_id=>wwv_flow_imp.id(13952621789457753)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(13953546608457755)
,p_plug_template_id=>wwv_flow_imp.id(13952621789457753)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(13953825786457755)
,p_plug_template_id=>wwv_flow_imp.id(13952621789457753)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(13954196764457756)
,p_plug_template_id=>wwv_flow_imp.id(13952621789457753)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(13954463305457756)
,p_plug_template_id=>wwv_flow_imp.id(13952621789457753)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(13954717241457756)
,p_plug_template_id=>wwv_flow_imp.id(13952621789457753)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(13955081803457756)
,p_plug_template_id=>wwv_flow_imp.id(13952621789457753)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(13955394293457756)
,p_plug_template_id=>wwv_flow_imp.id(13952621789457753)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(13955650053457757)
,p_plug_template_id=>wwv_flow_imp.id(13952621789457753)
,p_name=>'Sub Regions'
