...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(28143878822133959)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(28144189242133960)
,p_plug_template_id=>wwv_flow_imp.id(28143878822133959)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(28144548648133961)
,p_plug_template_id=>wwv_flow_imp.id(28143878822133959)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(28144803641133961)
,p_plug_template_id=>wwv_flow_imp.id(28143878822133959)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(28145082819133961)
,p_plug_template_id=>wwv_flow_imp.id(28143878822133959)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(28145453797133962)
,p_plug_template_id=>wwv_flow_imp.id(28143878822133959)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(28145720338133962)
,p_plug_template_id=>wwv_flow_imp.id(28143878822133959)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(28145974274133962)
,p_plug_template_id=>wwv_flow_imp.id(28143878822133959)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(28146338836133962)
,p_plug_template_id=>wwv_flow_imp.id(28143878822133959)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(28146651326133962)
,p_plug_template_id=>wwv_flow_imp.id(28143878822133959)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(28146907086133963)
,p_plug_template_id=>wwv_flow_imp.id(28143878822133959)
,p_name=>'Sub Regions'
