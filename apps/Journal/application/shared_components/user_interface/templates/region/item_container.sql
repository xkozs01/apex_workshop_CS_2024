...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(13978056628457772)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(13978371387457772)
,p_plug_template_id=>wwv_flow_imp.id(13978056628457772)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(13978657688457772)
,p_plug_template_id=>wwv_flow_imp.id(13978056628457772)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(13978961604457772)
,p_plug_template_id=>wwv_flow_imp.id(13978056628457772)
,p_name=>'Button Start'
