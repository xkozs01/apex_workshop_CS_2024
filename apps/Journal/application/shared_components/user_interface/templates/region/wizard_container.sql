...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(28194461476133996)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(28194804142133996)
,p_plug_template_id=>wwv_flow_imp.id(28194461476133996)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(28195123428133996)
,p_plug_template_id=>wwv_flow_imp.id(28194461476133996)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(28195390684133997)
,p_plug_template_id=>wwv_flow_imp.id(28194461476133996)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(28195699653133997)
,p_plug_template_id=>wwv_flow_imp.id(28194461476133996)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(28195957136133997)
,p_plug_template_id=>wwv_flow_imp.id(28194461476133996)
