...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(28137407542133954)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(28137749729133955)
,p_plug_template_id=>wwv_flow_imp.id(28137407542133954)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(28138056152133955)
,p_plug_template_id=>wwv_flow_imp.id(28137407542133954)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(28138268323133955)
,p_plug_template_id=>wwv_flow_imp.id(28137407542133954)
,p_name=>'Sub Regions'
