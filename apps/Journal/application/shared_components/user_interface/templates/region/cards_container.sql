...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(13946150509457748)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(13946492696457749)
,p_plug_template_id=>wwv_flow_imp.id(13946150509457748)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(13946799119457749)
,p_plug_template_id=>wwv_flow_imp.id(13946150509457748)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(13947011290457749)
,p_plug_template_id=>wwv_flow_imp.id(13946150509457748)
,p_name=>'Sub Regions'
