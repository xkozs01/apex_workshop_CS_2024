...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(28139321211133955)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(28139634741133956)
,p_plug_template_id=>wwv_flow_imp.id(28139321211133955)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(28139947175133956)
,p_plug_template_id=>wwv_flow_imp.id(28139321211133955)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(28140225308133956)
,p_plug_template_id=>wwv_flow_imp.id(28139321211133955)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(28140554926133956)
,p_plug_template_id=>wwv_flow_imp.id(28139321211133955)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(28140757583133956)
,p_plug_template_id=>wwv_flow_imp.id(28139321211133955)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(28141116277133956)
,p_plug_template_id=>wwv_flow_imp.id(28139321211133955)
,p_name=>'Sub Regions'
