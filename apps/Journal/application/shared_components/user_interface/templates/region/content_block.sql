...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(13948064178457749)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(13948377708457750)
,p_plug_template_id=>wwv_flow_imp.id(13948064178457749)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(13948690142457750)
,p_plug_template_id=>wwv_flow_imp.id(13948064178457749)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(13948968275457750)
,p_plug_template_id=>wwv_flow_imp.id(13948064178457749)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(13949297893457750)
,p_plug_template_id=>wwv_flow_imp.id(13948064178457749)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(13949500550457750)
,p_plug_template_id=>wwv_flow_imp.id(13948064178457749)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(13949859244457750)
,p_plug_template_id=>wwv_flow_imp.id(13948064178457749)
,p_name=>'Sub Regions'
