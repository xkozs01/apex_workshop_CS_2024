...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(28128687836133948)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(28129003554133949)
,p_plug_template_id=>wwv_flow_imp.id(28128687836133948)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(28129329477133949)
,p_plug_template_id=>wwv_flow_imp.id(28128687836133948)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(28129566545133949)
,p_plug_template_id=>wwv_flow_imp.id(28128687836133948)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(28129954471133949)
,p_plug_template_id=>wwv_flow_imp.id(28128687836133948)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(28130223964133949)
,p_plug_template_id=>wwv_flow_imp.id(28128687836133948)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(28130514631133949)
,p_plug_template_id=>wwv_flow_imp.id(28128687836133948)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(28130817143133949)
,p_plug_template_id=>wwv_flow_imp.id(28128687836133948)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(28131107335133950)
,p_plug_template_id=>wwv_flow_imp.id(28128687836133948)
,p_name=>'Sub Regions'
