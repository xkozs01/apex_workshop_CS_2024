...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(13937430803457742)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(13937746521457743)
,p_plug_template_id=>wwv_flow_imp.id(13937430803457742)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(13938072444457743)
,p_plug_template_id=>wwv_flow_imp.id(13937430803457742)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(13938309512457743)
,p_plug_template_id=>wwv_flow_imp.id(13937430803457742)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(13938697438457743)
,p_plug_template_id=>wwv_flow_imp.id(13937430803457742)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(13938966931457743)
,p_plug_template_id=>wwv_flow_imp.id(13937430803457742)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(13939257598457743)
,p_plug_template_id=>wwv_flow_imp.id(13937430803457742)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(13939560110457743)
,p_plug_template_id=>wwv_flow_imp.id(13937430803457742)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(13939850302457744)
,p_plug_template_id=>wwv_flow_imp.id(13937430803457742)
,p_name=>'Sub Regions'
