...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(13932093430457738)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(13932336459457738)
,p_plug_template_id=>wwv_flow_imp.id(13932093430457738)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(13932678497457739)
,p_plug_template_id=>wwv_flow_imp.id(13932093430457738)
,p_name=>'Sub Regions'
