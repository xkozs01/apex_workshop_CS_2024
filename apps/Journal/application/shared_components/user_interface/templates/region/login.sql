...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(28171783706133979)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(28172121111133980)
,p_plug_template_id=>wwv_flow_imp.id(28171783706133979)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(28172418374133980)
,p_plug_template_id=>wwv_flow_imp.id(28171783706133979)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(28172688017133980)
,p_plug_template_id=>wwv_flow_imp.id(28171783706133979)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(28173047633133980)
,p_plug_template_id=>wwv_flow_imp.id(28171783706133979)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(28173281101133980)
,p_plug_template_id=>wwv_flow_imp.id(28171783706133979)
,p_name=>'Sub Regions'
