...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(13980526673457773)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(13980864078457774)
,p_plug_template_id=>wwv_flow_imp.id(13980526673457773)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(13981161341457774)
,p_plug_template_id=>wwv_flow_imp.id(13980526673457773)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(13981430984457774)
,p_plug_template_id=>wwv_flow_imp.id(13980526673457773)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(13981790600457774)
,p_plug_template_id=>wwv_flow_imp.id(13980526673457773)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(13982024068457774)
,p_plug_template_id=>wwv_flow_imp.id(13980526673457773)
,p_name=>'Sub Regions'
