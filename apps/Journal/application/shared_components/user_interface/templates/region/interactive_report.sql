...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(28167231620133976)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(28167465012133977)
,p_plug_template_id=>wwv_flow_imp.id(28167231620133976)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(28167759898133977)
,p_plug_template_id=>wwv_flow_imp.id(28167231620133976)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(28168059501133977)
,p_plug_template_id=>wwv_flow_imp.id(28167231620133976)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(28168376203133977)
,p_plug_template_id=>wwv_flow_imp.id(28167231620133976)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(28168754425133977)
,p_plug_template_id=>wwv_flow_imp.id(28167231620133976)
,p_name=>'Sub Regions'
