prompt --application/shared_components/user_interface/lovs/dept_dname1
begin
--   Manifest
--     DEPT.DNAME1
--   Manifest End
...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(23453069153023007867)
,p_lov_name=>'DEPT.DNAME1'
,p_source_type=>'TABLE'
,p_location=>'LOCAL'
,p_query_table=>'DEPT'
