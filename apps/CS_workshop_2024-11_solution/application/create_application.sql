...
,p_name=>nvl(wwv_flow_application_install.get_application_name,'CS_workshop_2024-11 - solution')
...
,p_authentication_id=>wwv_flow_imp.id(80480276587074978117)
